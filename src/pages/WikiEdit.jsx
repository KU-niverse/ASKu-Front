...
const WikiEdit = () => {
    ...
    useEffect(() => {
        ...
        const getWiki = async () => {
            try{
                ...
                const result = await axios.get(`https://localhost:8080/wiki/contents/${main}/section/${section}`,{
    ...
    const addWikiEdit = async (e) => {
        ...
        try {
            const result = await axios.post(`https://localhost:8080/wiki/contents/${main}/section/${section}`, {
                version: version,
