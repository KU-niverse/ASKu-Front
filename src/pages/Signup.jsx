        ...
        <form>
            ...
            <div className={`${styles.signup_input}`}>
                <div className={`${styles.signup_head}`}>
                    <span>아이디</span>
                    <span className={`${styles.signup_alert}`}><BsCheck2All size='10'/>&nbsp;중복확인</span>
                </div>
            ...
            <div className={`${styles.signup_input}`}>
                <div className={`${styles.signup_head}`}>
                    <span>비밀번호</span>
                    <span className={`${styles.signup_alert}`}><FiAlertCircle size='10'/>&nbsp;8자이상-20자미만, 영문, 숫자, 특수문자로 입력해주세요</span>
                </div>
            ...
            <div className={`${styles.signup_input}`}>
                <div className={`${styles.signup_head}`}>
                    <span>비밀번호 재확인</span>
                    <span className={`${styles.signup_alert}`}><FiAlertTriangle size='10'/>&nbsp;비밀번호가 일치하지 않습니다</span>
                </div>
