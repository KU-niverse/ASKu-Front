...
/user/mypage/info', setMypageData);
    getData(`http://localhost:8080
/user/mypage/questionhistory/latest`, setMyQuestion);
    getData('http://localhost:8080
/user/mypage/debatehistory', setMyDebate);
    getData('http://localhost:8080
/user/mypage/badgehistory', setMyBadge);
    getData('http://localhost:8080
/user/mypage/wikihistory', setMyWiki);
    getData('http://localhost:8080
/wiki/contributions', setMyContribute);
  }, []);
