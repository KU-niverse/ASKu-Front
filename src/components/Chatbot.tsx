    ...
    <div className={styles.chatBot}>
      ...
      <div className={styles.chat}>
        ...
        <div className={styles.suggest} style={{ display: showSuggest ? 'block' : 'none' }}>
          ...
          <span id={'ref_res_1'} className={styles.textBox} onClick={() => handleSuggestClick('너는 누구야?')}>
            {'너는 누구야?\r'}
          </span>
          <span
            id={'ref_res_2'}
          ...
          <span id={'ref_res_4'} className={styles.textBox} onClick={() => handleSuggestClick('이중전공은 어떻게 해?')}>
            {'이중전공은 어떻게 해?\r'}
          </span>
        </div>
